...
2. Split the dataset into feature (Level) and target (Salary).
3. Create and train the Decision Tree Regressor model using the dataset.
4. Predict salaries for given levels and visualize the regression results using a graph.
...
## Output:
<img width="1483" height="821" alt="image" src="https://github.com/user-attachments/assets/0afe6090-9a50-4548-8060-60e3d05cb538" />
